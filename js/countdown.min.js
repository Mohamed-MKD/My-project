	...
	$.fn.showclock = function(obj) {
	    ...
	    if(days!=0){
		    html+="<div class='countdown-container days'>"
		    	...
		    	html+="<span class='countdown-value days-bottom'>"+"<br>"+obj.countDown_days+"</span>";
		    html+="</div>";
		}

	    html+="<div class='countdown-container hours'>"
	    	html+="<span class='countdown-heading hours-top'>"+pad(hours)+"</span>";
	    	html+="<span class='countdown-value hours-bottom'>"+"<br>"+obj.countDown_hours+"</span>";
	    html+="</div>";

	    html+="<div class='countdown-container minutes'>"
	    	html+="<span class='countdown-heading minutes-top'>"+pad(minutes)+"</span>";
	    	html+="<span class='countdown-value minutes-bottom'>"+"<br>"+obj.countDown_minutes+"</span>";
	    html+="</div>";

	    html+="<div class='countdown-container seconds'>"
	    	html+="<span class='countdown-heading seconds-top'>"+pad(seconds)+"</span>";
	    	html+="<span class='countdown-value seconds-bottom'>"+"<br>"+obj.countDown_seconds+"</span>";
	    html+="</div>";
